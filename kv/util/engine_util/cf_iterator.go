...
// BadgerIterator implements the DBIterator interface.
type BadgerIterator struct {
	iter   *badger.Iterator
	prefix string
}

// NewCFIterator creates a new instance of DBIterator with column family support.
...
type DBIterator interface {
	// Item returns a pointer to the current key-value pair.
	Item() DBItem
